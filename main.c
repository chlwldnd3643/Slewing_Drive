...
const unsigned long TIMEOUT_TxPDO2 = 500;

// digital outputs
const int INVERTER_PIN = 4;
const int SS1_STO_PIN = 3;
...
void setup() {
  ...
  if (operational) {
    ...
    receiveTimeoutTimer1();   // TxPDO1 timer 시작
    receiveTimeoutTimer2();   // TxPDO2 timer 시작
  } else {
...
void disableSafety() {
  digitalWrite(SS1_STO_PIN, LOW); // SS1_STO open
...
void enableSafety() {
  digitalWrite(SS1_STO_PIN, HIGH);  // SS1_STO close
